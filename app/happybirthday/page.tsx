...
export default function HappyBirthday() {
  ...
  return (
    <div>
      {/* Photo */}
      <div className="absolute flex flex-col items-center -top-0 right-20 z-0 animate-fade-down animate-once animate-duration-1000 animate-delay-[2100ms] animate-ease-in">
        <div className="w-0.5 shadow h-40 bg-amber-950/40"></div>
      ...
      {/* Photo */}
      <div className="absolute flex flex-col items-center top-0 left-20 z-0 animate-fade-down animate-once animate-duration-1000 animate-delay-[2600ms] animate-ease-in">
        <div className="w-0.5 shadow h-100 bg-amber-950/40"></div>
        <div className="animate-wiggle animate-infinite animate-duration-[6000ms] animate-delay-[2100ms] animate-ease-in-out w-fit h-fit">
          <Image
            src={"/images/Test1.png"}
            alt=""
            width={200}
      ...
      <div
        className="z-2 w-screen h-full bg-pink-950 fixed top-0 left-0 flex flex-col items-center justify-center animate-flip-down animate-duration-500 animate-delay-[2000ms] animate-ease-in animate-reverse"
        onAnimationEnd={() => {
